...
mcpServer.registerResource("document", "document://document-getting-started", {
...
mcpServer.registerResource("config", "config://app", {
...
mcpServer.registerResource("user-profile", new ResourceTemplate("users://{userId}/profile", { list: undefined }), {
    title: "User Profile",
...
mcpServer.registerResource("repository", new ResourceTemplate("github://repos/{owner}/{repo}", {
    list: undefined,
    complete: {
...
mcpServer.registerTool("list-files", {
    title: "List Files",
...
mcpServer.registerPrompt("review-code", {
    title: "Code Review",
...
mcpServer.registerPrompt("team-greeting", {
    title: "Team Greeting",
...
async function registerTools() {
    for (const toolPath of toolPaths) {
        ...
        try {
            ...
            mcpServer.registerTool(toolName, definition_obj, async (args, extra) => {
