 ...
 */
const executeFunction = async ({ id, name, description, type, amount, max_amount, expiration_date, start_date, random_count, minimum_amount, uses_per_user, usage_limit, customer_phones, target_type, work_with_promotion, first_order, free_delivery, show_in_product, check_all_conditions, conditions, vendor_id, mobile_only, payment_methods, customer_ids }) => {
