 ...
 */
const executeFunction = async ({ term = "", state_id = "", date_from = "", date_to = "", start_date_time = "", end_date_time = "", branch_ids = [], customer_name = "", customer_email = "", customer_phone = "", per_page = 20, page = 1 }) => {
