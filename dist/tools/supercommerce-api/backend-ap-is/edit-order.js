 ...
 */
const executeFunction = async ({ id, user_id, address_id, items, notes = "", delivery_fees = 0, notify_customer = true, overwrite_fees = null, }) => {
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    delivery_fees: {
                        type: "integer",
                        description: "The delivery fees for the order. If you want to override the delivery fees, set this to the new amount.",
                    },
                    overwrite_fees: {
                        type: ["integer", "null"],
                        description: "Set to 1 to override delivery fees with the new amount, or null to leave delivery fees unchanged.",
                    },
                    notify_customer: {
                        type: "boolean",
